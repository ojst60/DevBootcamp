...
// Model type
export type IBootcampModel = Model<IBootcampSchema, {}>

const BootcampSchema = new Schema<IBootcampSchema, IBootcampModel>(
  {
    name: {
      type: String,
...
// Cascade remove courses when a bootcamp is deleted
BootcampSchema.pre(
  'deleteOne',
  { document: true, query: false },
  async function (this: mongoose.Document, next) {
    console.log('course being removed from bootcamp')
    await this.model('Course').deleteOne({ bootcamp: this._id })
    next()
  }
)
